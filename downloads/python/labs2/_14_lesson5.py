...
## @package _14_lesson5
#
# This code was created by Richard Campbell '99 and ported to Python/PyOpenGL
# by John Ferguson and Tony Colston 2000.
# To be honest I stole all of John Ferguson's code and just added the changed stuff for lesson 5.
# So he did most of the hard work.
#
...
__date__ = str.join(' ', '$Date: 2002/12/31 04:13:56 $'.split()[1:3])
