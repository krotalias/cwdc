...
http://pydoc.net/Python/PyOpenGL-Demo/3.0.1b1/PyOpenGL-Demo.NeHe.lesson48.ArcBall/
...
##
#  Sets the rotational component (upper 3x3) of a given matrix to the matrix
