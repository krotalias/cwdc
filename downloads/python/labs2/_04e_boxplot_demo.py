#!/usr/bin/env python
#
## @package _04e_boxplot_demo
#
#  A matplotlib example.
#
#  @author Paulo Roma
#  @since 03/11/2021
#  @see https://matplotlib.org/stable/gallery/statistics/boxplot_demo.html#sphx-glr-gallery-statistics-boxplot-demo-py
...
# We want to play with how an IID bootstrap resample of the data preserves
# the distributional properties of the original sample,
