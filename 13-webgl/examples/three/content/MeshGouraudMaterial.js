 ...
 * Summary.
 *
 * <p>MeshGouraudMaterial is an addon material in Three.js
 * used to implement per-vertex (Gouraud) shading.</p>
 * In early versions of Three.js, this per-vertex behavior belonged to MeshLambertMaterial.
 * However, starting from r144, MeshLambertMaterial was upgraded to use
 * per-fragment (Phong) shading to improve visual quality.
 * To preserve the low-cost, retro look of vertex-based lighting for specific use cases,
 * the original functionality was moved into the examples folder as MeshGouraudMaterial.
 *
 * @author Ricardo Cabello ({@link https://coopermrdoob.weebly.com/ Mr.doob})
 * @see <a href="/cwdc/13-webgl/examples/three/content/MeshGouraudMaterial.js">source</a>
 *
 */
...
/**
 * Class for {@link https://en.wikipedia.org/wiki/Gouraud_shading Gouraud shading}.
 * @class
