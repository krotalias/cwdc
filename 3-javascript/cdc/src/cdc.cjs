 ...
 * @file
 *
 * <p>Callback for CDC <a href="../cdc/PDFs/CDC2.pdf">calculations</a> without modules.</p>
 *
 * Data supplied through a form and output into three &lt;div&gt; elements:
 * <ul>
 ...
 * @author Paulo Roma
 * @date 25/10/2023
 * @see <a href="/cwdc/3-javascript/cdc/src/cdc.cjs">source</a>
